#' Look Up Table (lut) between iris_code and atome_indcvi, obtained by comparison of administrative dataset from INSEE & RP INDCVI detail file 2020 for reg_code == "11"
#'
#' Look Up Table (lut) between iris_code and atome_indcvi, obtained by comparison of administrative dataset from INSEE & RP INDCVI detail file 2020 for reg_code == "11".
