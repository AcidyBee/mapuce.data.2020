#' Spatial dataset (sfc_multipolygon) at the atome_indcvi granularity from union of polygons of IGN/INSEE COUTOURS-IRIS file for millesime 2022 for reg_code == "11"
#'
